...
LIBS=-lz
PROG=kc-c1 kc-c2 kc-c3 kc-c4 kc-c7 kc-lm kc-cpp1 kc-cpp2 yak-count
...
# kc-lm: low-memory / low-end build; only needs zlib
kc-lm:kc-lm.c khashl.h ketopt.h kseq.h
	$(CC) $(CFLAGS) -o $@ $< $(LIBS)
